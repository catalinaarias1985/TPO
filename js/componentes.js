...
data(){
    ...
    'pie':{
        template:'<div class="grid-container bg-dark text-light"><div class="grid-item"><div class="horarios">Nuestros Horarios<br> Martes a Domingos y Festivos<br> de 5pm a 12am</div></div><div class="grid-item"><a href="https://instagram.com/lahuerta_bar?igshid=YmMyMTA2M2Y=" target="_blank"> <img class="igicon" src="images/instagram.png" alt="Instagram" /></a><a href="https://api.whatsapp.com/send?phone=573196111218" target="_blank"> <img class="igicon" src="images/whatsapp.png" alt="WhatsApp" /></a><p>Derechos Reservados @2022</p></div><div class="grid-item"><p>Telefono:319 6111218</p></div></div>'
    }
